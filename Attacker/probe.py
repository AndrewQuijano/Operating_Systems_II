def ping(ping_target="127.0.0.1", time_out=5, src="192.168."):
...
def host_scan(host, min_port=1024, max_port=65535, time_out=2, src="192.168."):
...
# such as port 0:
def udp_ping(host, min_port=0, max_port=65535, time_out=2, src="192.168."):
