...
def drop_columns(file_path, begin=0, end=9, begin_2=21, end_2=41):
    ...
    df.to_csv("modified_" + file_parts, index=False, header=False)
...
def kdd_prep(file_path):
    ...
    serv = ["http", "smtp", "domain_u", "auth", "finger", "telnet", "eco_i", "ftp", "ntp_u",
            ...
            "urh_i", "http_2784", "harvest", "aol", "tftp_u", "http_8001", "tim_i", "red_i"]
